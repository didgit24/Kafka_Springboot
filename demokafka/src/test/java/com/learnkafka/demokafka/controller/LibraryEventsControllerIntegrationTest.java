...
public class LibraryEventsControllerIntegrationTest {
    ...
    void postLibraryEvent() throws InterruptedException {
        ...
        //Thread.sleep(3000);
        String expectedResults = "{\"libraryEventId\":null,\"libraryEventType\":\"NEW\",\"book\":{\"bookId\":123,\"bookName\":\"Kafka with SpringBoot\",\"bookAuthor\":\"Indranil\"}}";
        String value = consumerRecord.value();
        assertEquals(expectedResults, value);
    }
}
